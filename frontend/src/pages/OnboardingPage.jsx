...
const OnboardingPage = () => {
  ...
  return (
    <div className="h-screen bg-base-100 flex items-center justify-center p-4 overflow-hidden">
      <div className="card bg-base-200 w-full max-w-3xl shadow-xl overflow-auto max-h-full">
