...
const HomePage = () => {
  const queryClient = useQueryClient(); // for sending req to users
  const [outgoingRequestsIds, setOutgoingRequestsIds] = useState(new Set()); 
  // taki jinko req bhejdi unko sent req ka button disabled ho jae
  ...
  useEffect(() => {
    ...
    if (outgoingFriendReqs.length > 0) {
      outgoingFriendReqs.forEach((req) => {
        // handle both object and string _id
  ...
  return (
    <div className='p-4 sm:p-6 lg:p-8'>
      ...
      {/* time for cards now (recommended users)*/}
                  ...
                  >
                    <div className="card-body p-5 space-y-4">
                      ...
                      <button
                        ...
                        onClick={() => {
                          // optimistic update to instantly disable button
                          setOutgoingRequestsIds((prev) => new Set(prev).add(user._id));
